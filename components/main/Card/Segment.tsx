...
const items = [
  { id: 1, title: 'Gaming headset of hell', img: 'https://m.media-amazon.com/images/I/61j6ey6mBpL._AC_SL1024_.jpg', price: '129.90', rating: 3.6},
  { id: 2, title: '2020 Apple MacBook Air Laptop: Apple M1 Chip, 13” Retina Display, 8GB RAM, 256GB SSD Storage, Backlit Keyboard, FaceTime HD Camera, Touch ID. Works with iPhone/iPad; Space Gray AppleCare', img: 'https://m.media-amazon.com/images/I/71jG+e7roXL._AC_SL1500_.jpg', price: '998.00', rating: 5},
...
export default function Segment() {
  return (
    <div className='flex flex-row flex-wrap overflow-hidden pr-0 lg:pr-10 justify-start'>
