...
export default function({title, img, price}: Props) {
    const newPrice = price.split(".")
 
    return (
        <div className='max-w-[500px] md:max-w-[360px] h-[420px] min-h-[420px] min-w-[280px] flex-grow flex-shrink-0 basis-[100px] lg:basis-[310px] px-[10px] mb-4 mt-[12px] '>
            <div className='bg-white h-full w-full relative mb-0 mt-0 overflow-hidden pt-[20px] flex pb-[15px] flex-col rounded-md [box-shadow:0_0_3px_#ccc] transition-transform ease-in  duration-100 hover:scale-105 mx-auto lg:mx-5'>
                <div className='text-black font-bold mx-6 mb-4'>
                    <h2 className='hover:overflow-auto max-h-14 text-[1.3rem] leading-[1.2] text-ellipsis whitespace-normal line-clamp-2'>{title}</h2>
                </div>
                <div className='flex-grow h-[300px] px-[20px] max-h-[300px] mb-[-3rem] flex-shrink-0 '>
                    <Link href='/'>
                        <Image
                            alt="product image"
                ...
                <div className="flex flex-grow mx-4 items-center">
                    ...
                    <Link href={'#'} className='flex flex-grow mx-4'>
                        <div className='bg-yellow-400 max-h-[3rem] hover:bg-yellow-500 flex items-center  px-2 py-0 lg:py-2  rounded-lg mr-0 ml-auto flex-shrink-0'>
                            ...
                            <button className='ml-2 text-[1.5rem] md:text-[1.4rem] lg:text-[1.2rem] font-semibold flex flex-shrink-0 '>Add to cart</button>
                        </div>
                    </Link>
                </div>
