...
export default function ({ product }: ProductTypes) {
    ...
    return (
        <div className='max-w-[500px] md:max-w-[360px] h-[420px] min-h-[420px] min-w-[280px] flex-grow flex-shrink-0 basis-[100px] lg:basis-[310px] pl-4 mb-4 mt-[12px]' key={product.id}>
            <div className='relative bg-white h-full w-full overflow-hidden pt-[15px] flex pb-[15px] flex-col rounded-md [box-shadow:0_0_3px_#ccc] transition-transform ease-in  duration-100 hover:scale-105 mx-auto lg:mx-5'>
                ...
                <div className='flex justify-center'>
                    <div className='px-[20px] max-h-[300px]'>
                        <Link href='/'>
                            <Image
                                alt="product image"
                                className='max-h-[250px] max-w-full object-fill'
                                src={product.img}
                                width={310}
                                height={300}
                                priority={true}
                ...
                <div className="flex items-center justify-between absolute bottom-0 mb-2 w-full  px-2 ">
                    ...
                    <div className='hover:scale-105 bg-yellow-400 max-h-[3rem] hover:bg-yellow-500 flex items-center  px-2 py-0 lg:py-2  rounded-lg mr-0 ml-auto flex-shrink-0'>
