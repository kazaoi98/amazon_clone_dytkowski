            ...
            <div className='inline-flex whitespace-nowrap w-full max-h-[230px] lg:max-h-[220px]'>
                ...
                <div className='mt-1 flex flex-col leading-normal text-[0.95rem] pl-4 w-full mb-6'>
                    ...
                    <div className='flex text-[1.6rem] font-bold w-[3rem] mt-2 items-center relative'>
                        ...
                        <button onClick={() => handleDelete(item)} className='hover:no-underline lg:hover:underline flex items-center bg-red-400 rounded-full h-8 px-2 w-24 lg:w-24 font-semibold absolute bottom-0 ml-28 lg:mt-5 transition-transform ease-in duration-150 hover:scale-105'>
                            ...
                            <span className=' font-semibold ml-1 text-[1rem]'>Delete</span>
                        </button>

                    </div>
                </div>
                
                <span className='text-[1rem] lg:text-[1.2rem] font-bold float-right overflow-visible mt-2 relative ml-auto mr-0' >${item.price}</span>
