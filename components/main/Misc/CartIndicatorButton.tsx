...
export default function CartIndicatorButton() {
    ...
    return (
        <Link href={'/Cart'} className='md:mr-[11px] md:ml-[2px]  inline-flex hover:outline hover:outline-[1px]  hover:outline-white items-center ml-[2px] px-[4px] w-[4.6rem] leading-[1] py-[12px] pt-[10px] flex-shrink-0'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-8 h-8 text-white flex-shrink-0 z-[1] ">
            ...
            <span className='text-[1.2rem] lg:text-[1rem] text-white font-semibold translate-x-[-1.2rem] pr-4 mr-2'>Cart</span>
